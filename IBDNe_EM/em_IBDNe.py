...
def main():
    ...
    bin1, bin2, bin_midPoint1, bin_midPoint2, chr_len_cM, numInd = processIBD(args.ibdSeg, args.end)
    print(f'A total of {np.sum(bin1)+np.sum(bin2)} IBD segments read for {numInd} individuals.')
