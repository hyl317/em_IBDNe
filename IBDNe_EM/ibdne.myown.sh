...
python3 em_IBDNe.py -i ../../../simulate/extractIBD/Dominic/EUR.ts.200.ibd.gz -e endMarker.ts.txt --alpha 0.01 -o eur.ts_200.300 --max_iter 500 -G 300 > test.eur.ts_200.300.tail
