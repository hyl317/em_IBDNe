...
python3 em_IBDNe.py -i ../../../simulate/extractIBD/Dominic/FIN.ts.200.ibd.gz -e endMarker.ts.txt --alpha 0.05 -o fin.ts_200.100 --max_iter 2000 -G 100 > test.fin.ts_200.100.tail
